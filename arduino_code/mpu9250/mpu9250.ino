/* MPU9250 Basic Example Code
 by: Kris Winer
 date: April 1, 2014
 license: Beerware - Use this code however you'd like. If you find it useful you
 ...
 Teensy 3.1.  We have disabled the internal pull-ups used by the Wire library in
 the Wire.h/twi.c utility file.  We are also using the 400 kHz fast I2C mode by
 setting the TWI_FREQ  to 400000L /twi.h utility file.
 */
#include <SPI.h>
#include <Wire.h>
#include <SD.h>
...
//    Serial.print("Do u read me MPU9250");
...
//    // orientationmismatch in feeding the output to the quaternion filter.  For
//    // the MPU-9250, we have chosen a magnetic rotation that keeps the sensor
//    // forward along the x-axis just like in the LSM9DS0 sensor. This rotation can
//    // be modified to allow any convenient orientation convention.  This is ok by
...
void printData() {
    ...
    Serial.print("ax: "); Serial.print(1000*ax); Serial.print(" mg ");
    Serial.print("ay: "); Serial.print(1000*ay); Serial.print(" mg ");
    Serial.print("az: "); Serial.print(1000*az); Serial.println(" mg ");

    // Print gyro values in degree/sec
    Serial.print("gx: "); Serial.print(gx, 3); Serial.print(" degrees/sec "); 
    Serial.print("gy: "); Serial.print(gy, 3); Serial.print(" degrees/sec "); 
    Serial.print("gz: "); Serial.print(gz, 3); Serial.println(" degrees/sec"); 

    // Print mag values in degree/sec
    Serial.print("mx: "); Serial.print(mx); Serial.print(" mG "); 
    Serial.print("my: "); Serial.print(my); Serial.print(" mG "); 
   ...
   // Print temperature in degrees Centigrade
    ...
    Serial.print(temperature, 1);  Serial.println(" degrees C");
}
...
void I2Cscan()
  ...
  for(address = 1; address < 127; address++ ) 
  {
    ...
    Serial.print("beginning with address ");
